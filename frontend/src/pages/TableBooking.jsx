...
export default function TableBooking() {
  ...
  return (
    <div className="container my-5">
      <h2 className="mb-4 text-center">Book your table up to 30 minutes in advance</h2>
      <div className="row">
        
        <div className="col-md-6 mb-4">
          <div className="card shadow-sm">
            <div className="card-body">
              <h4 className="card-title"><i className="bi bi-calendar3 me-2"></i>Booking Information</h4>
              <form>
        ...
        <div className="col-md-6 mb-4">
          <div className="card shadow-sm h-100">
            <div className="card-body d-flex flex-column justify-content-center align-items-center">
              <h4 className="card-title"><i className="bi bi-people me-2"></i>Select Your Table</h4>
              {guests ? (
